...
const Item2 = () => {
  const handleClickScroll = React.useCallback((ev) => {
    animatedScroll(ev);
    sendAnalytics("scroll-2in1-click");
  }, []);
  ...
  return (
    <ItemWrap>
      ...
      <Content>
        <Title>
          Тестовый набор на двоих
          <br />
          за 499 ₽ с бесплатной доставкой
        </Title>
        <div>
          <SubTitle>
            Любой набор на выбор:
            <br />
            Борщ + Бефстроганов или уха + лазанья
          </SubTitle>
        </div>

        <ButtonSec href="#p2in1" onClick={handleClickScroll}>
          Выбрать набор
        </ButtonSec>
      </Content>
    </ItemWrap>
